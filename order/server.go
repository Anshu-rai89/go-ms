...
import (
	...
	account "github.com/Anshu-rai89/go-ms/account"
	catalog "github.com/Anshu-rai89/go-ms/catalog"
	pb "github.com/Anshu-rai89/go-ms/order/pb"
...
func (s *grpcServer) PostOrder(
	...
	orderedProducts, err := s.catalogClient.GetProductsByIds(ctx, productIDs)
	if err != nil {
...
func (s *grpcServer) GetOrdersForAccount(
	...
	products, err := s.catalogClient.GetProductsByIds(ctx, productIDs)
	if err != nil {
