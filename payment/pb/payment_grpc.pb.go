...
const (
	PaymentService_PostPayment_FullMethodName = "/pb.paymentService/PostPayment"
...
func (c *paymentServiceClient) PostPayment(ctx context.Context, in *PostPaymentRequest, opts ...grpc.CallOption) (*PostPaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PostPaymentResponse)
	err := c.cc.Invoke(ctx, PaymentService_PostPayment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPaymentServiceServer) PostPayment(context.Context, *PostPaymentRequest) (*PostPaymentResponse, error) {
...
func _PaymentService_PostPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PostPaymentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).PostPayment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_PostPayment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).PostPayment(ctx, req.(*PostPaymentRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _PaymentService_PostPayment_Handler,
		},
		{
